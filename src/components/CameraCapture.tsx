...
export const CameraCapture: React.FC<CameraCaptureProps> = ({ step, onCapture, onSkip }) => {
  ...
  const handleCaptureClick = () => {
    ...
    if (videoRef.current) {
      ...
      // Step 2 & 3 (Ingredients) is sent to the backend for Cloud Vision OCR. 1800px at 0.8 quality ensures it is sharp enough for tiny text while optimizing payload size.
